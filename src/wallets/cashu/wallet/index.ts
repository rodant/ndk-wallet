    ...
    static async from(event: NDKEvent, deterministicInfoEvent?: NDKEvent): Promise<NDKCashuWallet | undefined> {
        ...
        if (deterministicInfoEvent) {
            ...
            try {
                ...
                //TODO (rodant): rollback workaround in satshoot to solve amber decryption issue
                console.warn("Error decrypting deterministic wallet event! Continuing assuming it is already decrypted.");
